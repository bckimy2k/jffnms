...
function get_structure($struct_name)
{
  switch($struct_name)
  {
  case 'zones':
  ...
  case 'interface_types':
    return array(
      ...
      'fields'=>array(
          ...
          'snmp_oid' => array( 'name'=> 'Match SysObjectID', 'type'=>'textbox', 'size'=>30),
  ...
  case 'slas_cond':
    return array(
      ...
      'fields'=>array(
          ...
          'cond'=>array(  'name'=>'Condition',  'type'=>'textbox',  'size'=>100, 'filter'=>false),
 ...
 case 'traps':
  ...
  case 'interface_types_field_types':
    return array(
  ...
  case 'hosts':
    return array(
      ...
      'fields'=>array(
          ...
          'sysobjectid'=> array('name'=>'SysObjectId',  'type'=>'textbox', 'size'=>20, 'filter'=>false ),
 ...
 */
  case 'logfiles_match_items':
    return array(
      'title'=>'Log File Matches',
      'object'=>'logfiles_match_items',
      'show_id'=>1,
      'action_type'=>1,
      'no_records_message'=>'No Log File Match Items Found',
      'profile'=>'ADMIN_HOSTS',
      'filter_field'=>'logfile_id',
      'fields'=>array(
          'description'=>array('name'=>'Description', 'type'=>'textbox', 'size'=>30, 'filter'=>false),
          'pos'=>array(     'name'=>'Position', 'type'=>'textbox','size'=>3),
          'logfile_id'=>array( 'name'=>'Log File', 'type'=>'select', 'func'=>'select_logfiles', 'view'=>'logfile_description', 'size'=>30),
          'match_text'=>array('name'=>'Text Match', 'type'=>'textbox', 'size'=>40, 'filter'=>false),
          'host'=>array('name'=>'Host Field', 'type'=>'textbox', 'size'=>10, 'filter'=>false),
          'interface'=>array('name'=>'Interface Field', 'type'=>'textbox', 'size'=>10, 'filter'=>false),
          'username'=>array( 'name'=>'Username Field', 'type'=>'textbox', 'size'=>10, 'filter'=>false),
          'state'=>array( 'name'=>'State Field',  'type'=>'textbox', 'size'=>10, 'filter'=>false),
          'info'=>array( 'name'=>'Extra Info Field', 'type'=>'textbox', 'size'=>10, 'filter'=>false),
  ...
  case 'logfiles':
    return array(
      ...
      'action_type'=>2,
      'hide_record_one'=>0,
      'split'=>'logfiles_match_items',
      'split_standard'=>1,
      'split_view_name'=>'Items',
      'no_records_message'=>'No Log Files Found',
      'profile'=>'ADMIN_HOSTS',

      'fields'=>array(
          'description'=>array('name'=>'Description', 'type'=>'textbox', 'size'=>30),
          'filename'=>array('name'=>'Filename', 'type'=>'textbox', 'size'=>60, 'filter'=>false),
          NULL)
    );
    break;

  default:
        die(display_error('Admin Structure Not Found',"JFFNMS attempted to find a structure called '$struct_name' but was unable to. This is generally an internal error."));
  }
}
?>
