 ...
 */
	...
	if (count($satellite_slave)==1) {
		...
		if ($data_type_orig) {
		    ...
		    $time_dist_send = time_msec_diff($time_dist_send);
    	    ...
    	    $info[total_time]= time_msec_diff($time_dist_total);
